...
extension UIView {
    ...
    func anchorSize(to view: UIView, multiplier: CGFloat = 1) {
        translatesAutoresizingMaskIntoConstraints = false
        
        [widthAnchor.constraint(equalTo: view.heightAnchor, multiplier: multiplier), heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: multiplier)]
            .forEach {
                $0.priority = UILayoutPriority(999)
                $0.isActive = true
        }
    ...
    func anchorWidth(to view: UIView, multiplier: CGFloat = 1) {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func anchorHeigth(to view: UIView, multiplier: CGFloat = 1) {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func centerYInSuperview(size: CGSize = .zero) {
        ...
        //centerYAnchor.constraint(equalTo: superviewCenterYAnchor, constant: <#T##CGFloat#>)
